...
<div id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark text-white p-3 position-fixed h-100">
    ...
    <div id="homeSubmenu" class="collapse">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="#adminSubmenu" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="adminSubmenu">
                <i class="fas fa-user"></i> Admin
            </a>
            <div id="adminSubmenu" class="collapse">
                <ul class="nav flex-column pl-3 submenu">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="admin_user_content.php">Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#">Sub Admin</a>
                    </li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="#settingsSubmenu" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="settingsSubmenu">
                <i class="fas fa-cogs"></i> Settings
            </a>
            <div id="settingsSubmenu" class="collapse">
                <ul class="nav flex-column pl-3 submenu">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#">Setting 1</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#">Setting 2</a>
                    </li>
                </ul>
            </div>
        </li>
